...
void cameraWork(){
	...
	quaternion rotate_q = (quaternion){(float)cos(theta/2),(float)( sin(theta/2) * axis.x),(float) (sin(theta/2) * axis.y),(float)( sin(theta/2) * axis.z)};
